...
class settings {
  ...
  function __construct(){
    ...
    $this->info_box_links = array(
      ...
      array('link' => __( 'Documentation', 'zmplugin' ), 'url' => 'https://zmplugin.com/documentation/', 'rel' => 'nofollow', 'target' => '_blank', 'class' => ''),
      array('link' => __( 'Pro', 'zmplugin' ), 'url' => 'https://zmplugin.com/pro/', 'rel' => 'nofollow', 'target' => '_blank', 'class' => 'uk-text-danger'),
    );
