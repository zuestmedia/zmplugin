...
class com_navbar {
  ...
  function __construct(){
    ...
    $this->navbar_fontweight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_font_weight(10,3);
    $this->navbar_fontstyle = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontstyle(10,3);
    $this->navbar_letterspacing = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_letter_spacing(10,3);

    $this->navbar_height = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_height(10,3);
