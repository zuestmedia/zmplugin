...
class com_body {
  ...
  function __construct(){
    ...
    $this->body_font_weight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_font_weight(10,3);
    $this->body_letter_spacing = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_letter_spacing(10,3);
