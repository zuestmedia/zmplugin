...
class com_body {
  ...
  function __construct(){
    ...
    $this->text_lead_fontsize = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontsize_rem(10,2);
    $this->text_lead_fontsize->input_attrs['heading'] = __( 'Text Lead', 'zmplugin' );
    $this->text_lead_lineheight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_lineheight(10,2);

    $this->text_large_fontsize = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontsize_rem(10,2);
      $this->text_large_fontsize->input_attrs['heading'] = __( 'Text Large', 'zmplugin' );
    $this->text_large_lineheight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_lineheight(10,2);

    $this->article_meta_fontsize = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontsize_rem(10,2);
      $this->article_meta_fontsize->input_attrs['heading'] = __( 'Article Meta', 'zmplugin' );
    $this->article_meta_lineheight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_lineheight(10,2);

    $this->text_meta_fontsize = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontsize_rem(10,2);
      $this->text_meta_fontsize->input_attrs['heading'] = __( 'Text Meta', 'zmplugin' );
    $this->text_meta_lineheight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_lineheight(10,2);

    $this->text_small_fontsize = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_fontsize_rem(10,2);
      $this->text_small_fontsize->input_attrs['heading'] = __( 'Text Small', 'zmplugin' );
    $this->text_small_lineheight = new \ZMP\Plugin\Config\ThemeCustomizer\Controlls\_cssvar_lineheight(10,2);
